...
namespace Final_proyect
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM emergency_room";
        ...
        private void buscar()
        {
            ...
            string query = "SELECT * FROM emergency_room where ID='" + textBox3.Text + "' ";
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "INSERT INTO emergency_room(`ID`, `Name`, `Quantity`) VALUES (NULL, '" + textBox1.Text + "', '" + textBox2.Text + "')";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "DELETE FROM emergency_room WHERE ID='" + textBox3.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "UPDATE emergency_room SET Name='" + textBox1.Text + "',Quantity='" + textBox2.Text + "' WHERE ID='" + textBox3.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
