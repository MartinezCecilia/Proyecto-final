...
namespace Final_proyect
{
    public partial class Form6 : Form
    {
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM tochosurgery";
        ...
        private void buscar()
        {
            ...
            string query = "SELECT * FROM tochosurgery where ID='" + textBox3.Text + "' ";
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "INSERT INTO tochosurgery(`ID`, `Name`, `Quantity`) VALUES (NULL, '" + textBox1.Text + "', '" + textBox2.Text + "')";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "DELETE FROM tochosurgery WHERE ID='" + textBox3.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "UPDATE tochosurgery SET Name='" + textBox1.Text + "',Quantity='" + textBox2.Text + "' WHERE ID='" + textBox3.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
