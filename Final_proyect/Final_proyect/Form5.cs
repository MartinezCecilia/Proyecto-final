...
namespace Final_proyect
{
    public partial class Form5 : Form
    {
        ...
        private void buscar()
        {
            ...
            string query = "SELECT * FROM radiology where ID='" + textBox3.Text + "' ";
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "INSERT INTO radiology(`ID`, `Name`, `Quantity`) VALUES (NULL, '" + textBox1.Text + "', '" + textBox2.Text + "')";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "DELETE FROM radiology WHERE ID='" + textBox3.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventory";
            string query = "UPDATE radiology SET Name='" + textBox1.Text + "',Quantity='" + textBox2.Text + "' WHERE ID='" + textBox3.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
